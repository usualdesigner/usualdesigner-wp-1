...
?>
						<div id="portfolio-container">
								...
								<div class="portfolio-galleries" id="portfolio-galleries">
									...
									<div class="container">
										<div class="portfolio-filter-wrapper">
												...
												<div class="filter_menu">
													<span class="label-title"><?php _e('Sort Portfolio:','wpdance');?></span>
									...
									<?php	
										...
										<?php		
											$count++;
										endwhile;
										else : _e('Sorry. There are no posts to display', 'wpdance');
										endif;	
									?>	
									</div>
								</div>
							...
							<div class="end_content">
							   <div class="count_project"><span class="number_project"><?php echo $wp_query->post_count; ?></span> <?php _e('Project(s)','wpdance');?></div>
