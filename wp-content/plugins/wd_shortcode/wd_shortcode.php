...
class WD_Shortcode
{
	...
	protected function initArrShortcodes(){
		...
		,'recent_post','typography','column_article','bt_buttons','portfolio','bt_accordion','bt_labels'
		,'bt_badges','bt_multitab','bt_tooltips','bt_carousel','wd_features','wd_testimonial','woo-shortcode');
	}
