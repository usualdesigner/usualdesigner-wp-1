...
if(!function_exists ('button')){
	function button($atts,$content){
		...
		if( strlen($link) > 0 ){
			return "<a data-style_hover='color:{$color_hover};background-color:{$background_hover};border-color:{$border_color_hover}' style='color:{$color};background-color:{$background};border-color:{$border_color}' href='$link' class='wd-shortcode-button btn {$size}'>".do_shortcode($content)."</a>";
		}
		return "<button data-style_hover='color:{$color_hover};background-color:{$background_hover};border-color:{$border_color_hover}' style='color:{$color};background-color:{$background};border-color:{$border_color}' class='wd-shortcode-button btn {$size}'>".do_shortcode($content)."</button>";	
	}
}
