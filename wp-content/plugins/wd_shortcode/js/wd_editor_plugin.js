(function() {
    ...
    tinymce.PluginManager.add('Wd_shortcodes', function( editor, url ) {
		...
		//recent post
		wd_mce_addMenu(menu, 'recent post','[recent_blogs layout="vertical" category="" columns="1" number_posts="" title="yes" thumbnail="yes" meta="yes" tag="yes" sharing="yes" excerpt="yes" excerpt_words="30"]');
		//testimonial
