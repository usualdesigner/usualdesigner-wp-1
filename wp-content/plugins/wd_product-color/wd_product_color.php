...
class WD_Shopbycolor {
	...
	?>
		...
		<tr class="form-field form-required">
			...
			<td>
				...
				<span class="description"><?php _e('Use color picker to pick one color.','wpdance'); ?></span>
			</td>
		</tr>
		...
		<tr class="form-field">
			...
			<td>
				...
				<small>&nbsp;<a href="#" class="wd_pc_clear_image_button"><?php _e('Remove Image','wpdance'); ?></a></small>
				<br clear="all" />		
				<span class="description"><?php _e('Choose one thumbnail.','wpdance'); ?></span>
			</td>
		</tr>
	...
	<div class="form-field form-required">
		...
		<p><?php _e('Use color picker to pick one color.','wpdance'); ?></p>
	</div>
	...
	<div class="form-field">
		...
		<small>&nbsp;<a href="#" class="wd_pc_clear_image_button"><?php _e('Remove Image','wpdance'); ?></a></small>
		<br clear="all" />		
		<p><?php _e('Choose one thumbnail.','wpdance'); ?></p>
	</div>
		...
		if ( count( $terms ) > 0 ) {
			...
			if(1) {
				...
				foreach ( $terms as $term ) {
					...
					echo ( $count > 0 || $option_is_set ) ? '<div class="bg-hover"></div></a>' : '</span>';
