...
class Theme extends EWAbstractTheme
{
	...
	protected function initArrWidgets(){
		$this->arrWidgets = array('flickr','hot_product','best_selling_product','sale_product','wd_recent_post','emads','twitterupdate'
								,'recent_comments_custom','ew_social','productaz','ew_subscriptions','product_categories'
								,'recent_product_slider','related_upsell_product','popular_product_by_categories','tab_product','testimonial','wd_tag_cloud');
