...
if(!class_exists('WP_Widget_Product_Categories')){
	class WP_Widget_Product_Categories extends WP_Widget {
		...
		function WP_Widget_Product_Categories() {
			...
			$this->WP_Widget('wd_product_categories', __('WD - Product Categories','wpdance'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			$current_cat = (isset($_GET['product_cat']) && $_GET['product_cat']!='')?$_GET['product_cat']:'';
			?>
		...
		function get_sub_categories($category_id,$instance,$current_cat){
			...
			if($sub_cats) {
				...
				foreach($sub_cats as $sub_category) {
					...
					echo '<li>';
					echo '<span class="icon_toggle"></span>';
					echo '<a href="'. get_term_link($sub_category->slug, 'product_cat') .'" class="'.$current_class.'">'. $sub_category->name;
