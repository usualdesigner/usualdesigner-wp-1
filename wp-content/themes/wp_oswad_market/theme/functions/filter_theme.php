...
function my_search_form( $form ) {
	...
	<input type="text" value="' . get_search_query() . '" name="s" id="s'.$rand_id.'" class="search-input" required="required" placeholder="'.__('search entries store ...','wpdance').'"/>
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		,array(
			...
			'source'   				=> get_stylesheet_directory() . '/theme/includes/plugins/woocommerce-grid-list-toggle.zip', // The plugin source
		...
		,array(
			...
			'source'   				=> get_stylesheet_directory() . '/theme/includes/plugins/features-by-woothemes.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		,array(
			...
			'source'   				=> get_stylesheet_directory() . '/theme/includes/plugins/testimonials-by-woothemes.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		,array(
			...
			'source'   				=> get_stylesheet_directory() . '/theme/includes/plugins/yith-woocommerce-compare.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		,array(
			...
			'source'   				=> get_stylesheet_directory() . '/theme/includes/plugins/yith-woocommerce-wishlist.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		,array(
			...
			'source'   				=> get_stylesheet_directory() . '/theme/includes/plugins/contact-form-7.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
