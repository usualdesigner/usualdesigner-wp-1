<?php
		...
		$data = wd_array_atts(	array(
				...
				,'wd_link_color' 					=> "#f23534"
				,'wd_link_color_hover' 				=> "#f23534"
				...
				,'wd_menu_background_hover' 		=> "#f23534"
				,'wd_menu_border' 					=> "#e5e5e5"
				,'wd_menu_border_hover' 			=> "#f23534"
				,'wd_menu_border_top' 				=> "#c0c0c0"
				,'wd_menu_border_bottom' 			=> "#c1c1c1"
				...
				,'wd_sub_menu_text_color_hover' 	=> "#f23534"
				...
				,'wd_button_background_hover' 	=> "#f23534"
				...
				,'wd_label_title_sale_background'	=> "#f23534"
				...
				,'wd_social_icon_background_hover'	=> "#f23534"
				,'wd_sidebar_border'			=> "#d9d9d9"
				,'wd_heading_sidebar_color'			=> "#000000"
				,'wd_heading_sidebar_line_top'	=> "#f23534"
	...
	.rev_slider_wrapper .tp-rightarrow:hover,body * .ls-nav-next:hover,
	.rev_slider_wrapper .tp-leftarrow:hover,body * .ls-nav-prev:hover,
	...
	.shortcode-recent-blogs .social-share li a,
	.list-posts .post-content-info .social-share li a,
	.tags_social .social-share li a:before,
	div.product .wd-social-share .social-share li a:before{
		background-color:<?php echo $wd_input_border_color_hover; ?>;
		color:#fff;
	}
	.shortcode-recent-blogs .social-share li a:hover,
	.list-posts .post-content-info .social-share li a:hover,
	.tags_social .social-share li a:hover:before,
	div.product .wd-social-share .social-share li a:hover:before,
	.tags_social .tags .tag-links a:hover,div.product .tagcloud a:hover,
	...
	a.post-edit-link,.post-title a,
	.post-title a:hover{
		color:<?php echo $wd_theme_color_secondary; ?>;
	}
	
	.shortcode-recent-blogs .bottom-share:before,
	.shortcode-recent-blogs .info-detail:before,
	...
	{
		background-color:<?php echo $wd_box_border_color; ?>;
	}
	/*==*/
	...
	#to-top a:hover:before,ul.archive-product-subcategories > .product a:hover img{
	...
	/* ====================================== SOCIAL ICON COLOR ================================= */
	#header .social-share li a:before,
	...
	#header .social-share li a:hover:before,
	...
	body #header .wd_widget_product_categories h2.widgettitle{
		border-bottom-color:<?php echo $wd_menu_border_bottom; ?> !impportant;
	}
	...
	.bbp-pagination-links a.next,.bbp-pagination-links a.prev{
	...
	.bbp-pagination-links a{
		border-color:<?php echo $wd_button_slider_border; ?>;
		color:<?php echo $wd_button_slider_border; ?>;
	}
	...
	a.author:focus{
		color:<?php echo $wd_link_color_hover; ?> !imprortant;
	}
