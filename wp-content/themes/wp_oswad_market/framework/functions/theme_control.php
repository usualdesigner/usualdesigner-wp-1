...
function my_page_template_redirect(){
	...
	if($wp_query->is_page()){
		...
		$smof_data['wd_layout_style'] = strcmp($page_datas['page_layout'],'0') == 0 ? $smof_data['wd_layout_styles'] : $page_datas['page_layout'] ;
...
//					add_action( 'get_header',  'wd_init_sidebar_replacement' );
		...
		if( !$smof_data['wd_prod_share'] )
			remove_action( 'woocommerce_single_product_summary', 'wd_template_social_sharing', 35 );
