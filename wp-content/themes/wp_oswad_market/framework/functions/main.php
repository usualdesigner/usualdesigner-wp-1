<?php 
	...
	?>
			<div class="wd_mobile_account <?php echo wd_is_woocommerce()== false ? "full":"" ?>">
	...
	if(!function_exists ('wd_print_header_body')){
		...
		global $smof_data, $page_datas;
			...
			<div class="header-middle hidden-xs <?php echo $version; ?>">
				<div class="header-middle-content container">
					<div class="left-header-middle-content">
						<?php if( (int)$smof_data['wd_enable_header_search'] == 1 && $version=='v2'): ?>
						<div class="header_search"></span><?php get_search_form(); ?></div>
						<?php endif;?>
					</div>
					<!-- LOGO -->	
					<div class="middle-header-middle-content">
	...
	if(!function_exists ('wd_print_header_footer')){
		function wd_print_header_footer($version = 'v1'){
			global $smof_data;
	?>	
		<div class="header-bottom <?php echo ((int)$smof_data['wd_enable_header_search']==0 || $version!='v1')?'search-hidden':''; ?> <?php echo $version; ?>">
			...
			<div class="header-category">
				...
				jQuery(document).ready(function(){
					...
					if( typeof _on_tablet != 'undefined' && _on_tablet == 1 ){
						...
						jQuery(".header-category .wd_widget_product_categories").hover(
							function(){
	...
	add_action( 'wd_footer_init', 'wd_footer_init_widget_area_3', 40 );
	...
	add_action( 'wd_footer_init', 'wd_footer_init_widget_area_4', 30 );
	if(!function_exists ('wd_footer_init_widget_area_3')){
