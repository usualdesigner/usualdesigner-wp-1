...
/***** start single product hook *****/
	...
	add_action( 'woocommerce_single_product_summary', 'wd_template_social_sharing', 35 );
		...
		<div class="wd-social-share">
			...
			<ul class="social-share">
				<?php if((int)$smof_data['wd_enable_facebook'] == 1): ?>
					<li class="icon-facebook"><a href="http://www.facebook.com/<?php echo trim($smof_data['wd_facebook_id']); ?>" target="_blank" title="<?php _e('Become our fan', 'wpdance'); ?>" ><?php _e('Facebook', 'wpdance'); ?></a><span><?php _e('Become our fan', 'wpdance'); ?></span></li>				
				<?php endif; ?>
				<?php if((int)$smof_data['wd_enable_twitter'] == 1): ?>
					<li class="icon-twitter"><a href="http://twitter.com/<?php echo trim($smof_data['wd_twitter_id']); ?>" target="_blank" title="<?php _e('Follow us', 'wpdance'); ?>" ><?php _e('Twitter', 'wpdance'); ?></a><span><?php _e('Follow us', 'wpdance'); ?></span></li>
				<?php endif; ?>
				<?php if((int)$smof_data['wd_enable_flickr'] == 1): ?>
					<li class="icon-flickr"><a href="http://www.flickr.com/photos/<?php echo trim($smof_data['wd_flickr_id']); ?>" target="_blank" title="<?php _e('See Us', 'wpdance'); ?>" ><?php _e('Flickr', 'wpdance'); ?></a><span><?php _e('See Us', 'wpdance'); ?></span></li>
				<?php endif; ?>
				<?php if((int)$smof_data['wd_enable_google'] == 1): ?>
					<li class="icon-google"><a href="https://plus.google.com/<?php echo trim($smof_data['wd_google_id']); ?>" target="_blank" title="<?php _e('Join our circle', 'wpdance'); ?>"  ><?php _e('Google Plus', 'wpdance'); ?></a><span><?php _e('Join our circle', 'wpdance'); ?></span></li>
				<?php endif; ?>
				<?php if((int)$smof_data['wd_enable_rss'] == 1): ?>
					<li class="icon-rss"><a href="http://feeds.feedburner.com/<?php echo trim($smof_data['wd_rss_id']); ?>" target="_blank" title="<?php _e('Get updates', 'wpdance'); ?>" ><?php _e('RSS', 'wpdance'); ?></a><span><?php _e('Get updates', 'wpdance'); ?></span></li>
				<?php endif; ?>
				<?php if((int)$smof_data['wd_enable_vimeo'] == 1): ?>
					<li class="icon-vimeo"><a href="http://vimeo.com/<?php echo trim($smof_data['wd_vimeo_id']); ?>" target="_blank" title="<?php _e('See Us', 'wpdance'); ?>" ><?php _e('Vimeo', 'wpdance'); ?></a><span><?php _e('See Us', 'wpdance'); ?></span></li>
				<?php endif; ?>
			</ul>
		</div>
		<?php
...
if( class_exists('YITH_WCWL_UI') && class_exists('YITH_WCWL') ){
	function wd_add_wishlist_button_to_product_list(){
		...
		$html = str_replace("add-items-ajax-loading","add-items-ajax-loading-".rand(),$html);
		echo $html;
	}
