...
$of_options[] = array( 	"name" 		=> ""
						,"desc" 	=> "Thumbnail height. In px, default value: 100"
...
$of_options[] = array( 	"name" 		=> "Slider Button Border"
						,"desc" 	=> ""
...
$of_options[] = array( 	"name" 		=> "Slider Button Background Hover"
						,"desc" 	=> ""
...
$of_options[] = array( 	"name" 		=> "SlideShow Button"
						,"desc" 	=> ""
						,"id" 		=> "introduction_cart"
						,"std" 		=> "<h3 style=\"margin: 0 0 10px;\">Slideshow Button Color Scheme</h3>"
						,"icon" 	=> true
						,"type" 	=> "info"
				);				
$of_options[] = array( 	"name" 		=> "SlideShow Button Color"
						,"desc" 	=> ""
						,"id" 		=> "wd_button_slideshow_color"
						,"std" 		=> "#ffffff"
						,"type" 	=> "color"
				);
$of_options[] = array( 	"name" 		=> "Slider Button Color Hover"
						,"desc" 	=> ""
...
$of_options[] = array( 	"name" 		=> "Show Third Footer Widget Area(Footer Subscrible)"
						,"desc" 	=> "Show/Hide Third Footer Widget Area"
						,"id" 		=> "wd_show_third_footer_widget_area"
						,"std" 		=> 1
						,"type" 	=> "switch"
				);
$of_options[] = array( 	"name" 		=> "Background Show Third Footer Widget Area"
						,"desc" 	=> "Change your Background Show Third Footer Widget Area."
						,"id" 		=> "wd_bg_third_footer_widget_area"
						,"std"		=> $df_bg_third_footer_widget
						,"type" 	=> "upload");
$of_options[] = array( 	"name" 		=> "Show Fourth Footer Widget Area"
